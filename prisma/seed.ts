...
async function main() {
  ...
  await Promise.all([
    prisma.pago.create({ data: { transaccion_id: t1.id,  buyer_id: "clerk_buyer_001", monto: 48500, estado: "aprobado",  fecha: diasAtras(60) } }),
    prisma.pago.create({ data: { transaccion_id: t2.id,  buyer_id: "clerk_buyer_002", monto: 12000, estado: "aprobado",  fecha: diasAtras(55) } }),
    prisma.pago.create({ data: { transaccion_id: t3.id,  buyer_id: "clerk_buyer_001", monto: 32000, estado: "aprobado",  fecha: diasAtras(50) } }),
    prisma.pago.create({ data: { transaccion_id: t4.id,  buyer_id: "clerk_buyer_003", monto: 75000, estado: "aprobado",  fecha: diasAtras(45) } }),
    prisma.pago.create({ data: { transaccion_id: t5.id,  buyer_id: "clerk_buyer_004", monto: 9800,  estado: "rechazado", fecha: diasAtras(42) } }),
    prisma.pago.create({ data: { transaccion_id: t6.id,  buyer_id: "clerk_buyer_002", monto: 21500, estado: "aprobado",  fecha: diasAtras(38) } }),
    prisma.pago.create({ data: { transaccion_id: t7.id,  buyer_id: "clerk_buyer_005", monto: 55000, estado: "aprobado",  fecha: diasAtras(34) } }),
    prisma.pago.create({ data: { transaccion_id: t8.id,  buyer_id: "clerk_buyer_003", monto: 18200, estado: "aprobado",  fecha: diasAtras(30) } }),
    prisma.pago.create({ data: { transaccion_id: t9.id,  buyer_id: "clerk_buyer_001", monto: 43000, estado: "aprobado",  fecha: diasAtras(25) } }),
    prisma.pago.create({ data: { transaccion_id: t10.id, buyer_id: "clerk_buyer_006", monto: 6500,  estado: "aprobado",  fecha: diasAtras(20) } }),
    prisma.pago.create({ data: { transaccion_id: t11.id, buyer_id: "clerk_buyer_004", monto: 88000, estado: "aprobado",  fecha: diasAtras(15) } }),
    prisma.pago.create({ data: { transaccion_id: t12.id, buyer_id: "clerk_buyer_007", monto: 14300, estado: "pendiente", fecha: diasAtras(12) } }),
    prisma.pago.create({ data: { transaccion_id: t13.id, buyer_id: "clerk_buyer_005", monto: 37500, estado: "aprobado",  fecha: diasAtras(8)  } }),
    prisma.pago.create({ data: { transaccion_id: t14.id, buyer_id: "clerk_buyer_002", monto: 5200,  estado: "rechazado", fecha: diasAtras(5)  } }),
    prisma.pago.create({ data: { transaccion_id: t15.id, buyer_id: "clerk_buyer_006", monto: 29900, estado: "pendiente", fecha: diasAtras(2)  } }),
  ])

  // ─── Acreditaciones ───────────────────────────────────────────────────────

  await Promise.all([
    prisma.acreditacion.create({ data: { transaccion_id: t1.id, seller_id: "clerk_seller_001", monto: 44905, estado: "completada", fecha: diasAtras(57) } }),
    prisma.acreditacion.create({ data: { transaccion_id: t3.id, seller_id: "clerk_seller_002", monto: 29600, estado: "completada", fecha: diasAtras(47) } }),
    prisma.acreditacion.create({ data: { transaccion_id: t6.id, seller_id: "clerk_seller_003", monto: 19888, estado: "completada", fecha: diasAtras(35) } }),
    prisma.acreditacion.create({ data: { transaccion_id: t9.id, seller_id: "clerk_seller_004", monto: 39775, estado: "completada", fecha: diasAtras(22) } }),
  ])
  ...
  await Promise.all([
    ...
    // resueltos
    prisma.reclamo.create({ data: { transaccion_id: t1.id,  motivo: "PRODUCTO_INCORRECTO",   estado: "resuelto", fecha_apertura: diasAtras(55), fecha_resolucion: diasAtras(48), monto_reembolso: 48500  } }),
    prisma.reclamo.create({ data: { transaccion_id: t3.id,  motivo: "PRODUCTO_DANADO",       estado: "resuelto", fecha_apertura: diasAtras(46), fecha_resolucion: diasAtras(40), monto_reembolso: 16000  } }),
    ...
    prisma.reclamo.create({ data: { transaccion_id: t9.id,  motivo: "PRODUCTO_DANADO",       estado: "resuelto", fecha_apertura: diasAtras(22), fecha_resolucion: diasAtras(15), monto_reembolso: 21500  } }),
  ])
